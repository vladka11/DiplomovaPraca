        ...
        <ul class="list-unstyled components">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item align-items-end">
                    <button type="submit" onclick="offlineRezim()" class="btn btn-default">Offline režim </button>
                </li>
        </ul>
    </nav>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(".temy").click(function (e) {
                ...
                window.location.replace("http://localhost:8080/DiplomovaPraca/Home/onlineContent.php");
            });
        });
